	 ...
	 builder.ORDER_CREATE {
        ...
        ServiceResponse.Orders.Order.OrderItems.OrderItem.each { currentOrderItem ->
            MATERIAL_ITEM{
                ...
                def material_code__function_result = material_code__function(dicts_list.kipBendexArrayDET, dicts_list.kipBendexArrayCNF, dicts_list.prj_SapCodes_array, currentOrderItem)
