...
def dummy_matterial_item_function = { kipBendexArrayCNF_parameter, prj_coil_metal_ext_array_parameter, prj_coil_finish_ext_array_parameter, prj_coil_guige_ext_array_parameter, prj_coil_colour_ext_array_parameter, front_colour_colour_parameter, front_colour_type_parameter, front_colour_colour_IE_array_parameter, front_colour_type_IE_parameter, nodeValue_parameter->
    ...
    def extra_operations = null
        ...
        println("currentCreateNodeName_array is :" + currentCreateNodeName_array)
...
def dummy_matterial_item_function_result = dummy_matterial_item_function(dicts_list.prj_coil_metal_ext_array, dicts_list.prj_coil_finish_ext_array, dicts_list.prj_coil_guige_ext_array, dicts_list.prj_coil_colour_ext_array, dicts_list.front_colour_colour, dicts_list.front_colour_type, dicts_list.front_colour_colour_IE_array, dicts_list.front_colour_type_IE, nodeValue)


def dummy_matterial_item_NODE_MAKER_function = { dummy_ship_function_builder->
    def matterial_itemCreateNodeName_array = ["NodeName1", "NodeName2", "NodeName3"]
    def matterial_itemCreateNodeValue_array = ["NodeValue1", "NodeValue2", "NodeValue3"]

    i = 0

    while( i < matterial_itemCreateNodeName_array.size()){
        dummy_ship_function_builder."----ShoppingItemType----"(matterial_itemCreateNodeValue_array[i])
	 ...
	 builder.ORDER_CREATE {
        ...
        MATERIAL_ITEM{
			...
			"CONDITION"()
			"PRICE"("!!!__TBD_SCRIPT__!!!")
			"DISCOUNT"("!!!__TBD_SCRIPT__!!!")
			//"DUMMY_MATERIAL_ITEM"{
            dummy_matterial_item_NODE_MAKER_function(delegate)
            ...
            //    while(i < b){
            //        //"${currentCreateNodeName}"("${currentCreateNodeValue}")
            //        currentCreateNodeName = "currentCreateNodeName " + i
            //        currentCreateNodeValue = "currentCreateNodeValue " + i
            //       "${currentCreateNodeName}"("${currentCreateNodeValue}")
            //        i++
            //    }
            //}
			DETAILING{
				"DUMMY_DETAILING"("!!!__TBD_SCRIPT__!!!")
